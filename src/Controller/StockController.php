...
class StockController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $stock->setDatetime(new DateTime('now', new DateTimeZone('Pacific/Port_Moresby')));
            $stockItem = $this->itr->findOneBy(['itemCode' => $stock->getItem()]);
            // var_dump($stockItem); exit;
            $stockItem->setQuantity($stockItem->getQuantity() + $form->getData()->getQuantity());
